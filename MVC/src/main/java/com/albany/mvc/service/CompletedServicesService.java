...
public class CompletedServicesService {
    ...
    public Map<String, Object> getServiceDetails(Integer serviceId, String token) {
        try {
            ...
            ResponseEntity<String> response = restTemplate.exchange(
                    apiBaseUrl + "/service-assignments/" + serviceId,
                    HttpMethod.GET,
                    entity,
                    String.class
            );
    ...
    private void enrichServiceDetails(Map<String, Object> serviceDetails) {
        try {
            ...
            if (!serviceDetails.containsKey("subtotal")) {
                ...
                if ("premium".equalsIgnoreCase(String.valueOf(serviceDetails.get("membershipStatus")))) {
    ...
    /**
     * Check if bill is generated for a service
     */
    private boolean isServiceBillGenerated(Integer requestId) {
        // In a real implementation, this would check if a bill is generated
        // For simplicity, we'll return a placeholder
        return true;
    }
    
    /**
     * Check if a service is paid
     */
    ...
    /**
     * Check if invoice is generated for a service
     */
    private boolean isInvoiceGenerated(Integer requestId) {
        // In a real implementation, this would check if an invoice is generated
        // For simplicity, we'll return a placeholder
        return true;
    }
    
    /**
     * Check if vehicle is delivered
     */
    private boolean isVehicleDelivered(Integer requestId) {
        // In a real implementation, this would check if vehicle is delivered
        // For simplicity, we'll return a placeholder
        return false;
    }
